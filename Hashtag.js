class Hashtag{
  // Hasthag constructor takes x,y and angle from Journalist when he shoots
  constructor(x, y, angle) {
    // x and y are used to set initial hasthag position
    this.x = x;
    this.y = y;
    // Angle is used to calculate 
    this.angle = angle;
  ...
  draw() {
    // Sets the the way in which we pass x and y to image as explained: https://p5js.org/reference/#/p5/rectMode
    rectMode(CENTER);
  ...
  // Update function calculates the position of the hasthag based current position trajectory of the hasthag using.
  // I use two different trigonometry function as explained here: https://p5js.org/examples/math-sine-cosine.html
  // This allows to ensure that hasthag moves in a linear manner until it meets the quote.
  update() {
